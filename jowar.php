...
<body class="bg-dark">
    <center>
        <div class="container-fluid">
            <img src="jowar.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>Jowar</h3>
        </div>
        <p>Jowar, also known as sorghum, is a gluten-free grain that has been cultivated for centuries, particularly in Africa and India. It is rich in nutrients such as fiber, protein, vitamins, and minerals, making it a valuable addition to a healthy diet.</p>
        <div class="container-fluid">
            <table border="1">
                <tr>
