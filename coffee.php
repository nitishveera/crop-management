...
<body class="bg-dark">
    <center>
        <div class="container-fluid">
            <img src="coffee.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>Coffee</h3>
        </div>
        <p>Coffee is one of the world's most beloved beverages, celebrated for its rich flavor and stimulating effects. Derived from the roasted seeds of Coffea plants, coffee has a complex taste profile ranging from bitter to acidic, influenced by factors such as bean variety, roasting method, and brewing technique.</p>
        <div class="container-fluid">
            <table border="1">
                <tr>
