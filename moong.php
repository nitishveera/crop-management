...
<body class="bg-dark">
    <center>
        <div class="container-fluid">
            <img src="moong.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>Moong</h3>
        </div>
        <p>Moong, also known as mung bean or green gram, is a highly nutritious legume widely cultivated in Asia. These small, green beans are packed with essential nutrients, including protein, fiber, vitamins, and minerals. </p>
        <div class="container-fluid">
            <table border="1">
                <tr>
